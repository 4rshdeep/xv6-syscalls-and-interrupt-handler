...
main(int argc, char *argv[])
{
  ...
  toggle();
  11:	e8 1c 03 00 00       	call   332 <toggle>
  // fork(); 
  int fd = open("arr", 0);
  ...
  print_count();
  2d:	e8 08 03 00 00       	call   33a <print_count>
  exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 7c 07 00 00       	mov    $0x77c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 28 0a 00 00       	mov    0xa28,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 28 0a 00 00       	mov    %eax,0xa28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 28 0a 00 00    	mov    0xa28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 28 0a 00 00    	cmp    %eax,0xa28
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 28 0a 00 00    	mov    0xa28,%edx
 ...
 747:	0a 00 00 
 74a:	c7 05 2c 0a 00 00 2c 	movl   $0xa2c,0xa2c
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
 759:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 760:	00 00 00 
