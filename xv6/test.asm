...
int main(void)
{
   ...
   f:	83 ec 14             	sub    $0x14,%esp
	here = 1;
  12:	c7 05 64 0b 00 00 01 	movl   $0x1,0xb64
  19:	00 00 00 
	printf(1,"%s\n","IPC Test case");
  1c:	68 52 08 00 00       	push   $0x852
  21:	68 6c 08 00 00       	push   $0x86c
  26:	6a 01                	push   $0x1
  ...
  35:	85 c0                	test   %eax,%eax
	mean = 0;
  37:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
  3e:	00 00 00 
	if(cid==0){
  41:	75 15                	jne    58 <main+0x58>
		// This is child
		signal(foo);
  43:	83 ec 0c             	sub    $0xc,%esp
  46:	68 c0 00 00 00       	push   $0xc0
  4b:	e8 da 03 00 00       	call   42a <signal>
  50:	83 c4 10             	add    $0x10,%esp
  53:	eb fe                	jmp    53 <main+0x53>
  ...
  5b:	89 c3                	mov    %eax,%ebx
		mean = 10;
  5d:	c7 05 60 0b 00 00 0a 	movl   $0xa,0xb60
  64:	00 00 00 
		char *msg_child = (char *)malloc(MSGSIZE);
  67:	6a 08                	push   $0x8
  69:	e8 d2 06 00 00       	call   740 <malloc>
		msg_child = "P";
		// ps();
 		int pids[] = { cid }; 
  6e:	89 5d f4             	mov    %ebx,-0xc(%ebp)
		
		
		send_multi(getpid(), pids, msg_child, 1);	
  71:	e8 5c 03 00 00       	call   3d2 <getpid>
  76:	8d 55 f4             	lea    -0xc(%ebp),%edx
  79:	6a 01                	push   $0x1
  7b:	68 60 08 00 00       	push   $0x860
  80:	52                   	push   %edx
  81:	50                   	push   %eax
  82:	e8 9b 03 00 00       	call   422 <send_multi>
		printf(1,"1 PARENT: %s\n", msg_child );
  87:	83 c4 1c             	add    $0x1c,%esp
  8a:	68 60 08 00 00       	push   $0x860
  8f:	68 62 08 00 00       	push   $0x862
  94:	6a 01                	push   $0x1
  96:	e8 45 04 00 00       	call   4e0 <printf>
		
		free(msg_child);
  9b:	c7 04 24 60 08 00 00 	movl   $0x860,(%esp)
  a2:	e8 09 06 00 00       	call   6b0 <free>
		wait();
  a7:	e8 ae 02 00 00       	call   35a <wait>
	}
	printf(1,"Process is ending\n");
  ac:	58                   	pop    %eax
  ad:	5a                   	pop    %edx
  ae:	68 70 08 00 00       	push   $0x870
  b3:	6a 01                	push   $0x1
  b5:	e8 26 04 00 00       	call   4e0 <printf>
	exit();
  ba:	e8 93 02 00 00       	call   352 <exit>
  bf:	90                   	nop
...
void foo(void){
  ...
  c6:	68 38 08 00 00       	push   $0x838
  cb:	6a 01                	push   $0x1
  cd:	e8 0e 04 00 00       	call   4e0 <printf>
	printf(1,"Mean : %d\n", mean);
  d2:	83 c4 0c             	add    $0xc,%esp
  d5:	ff 35 60 0b 00 00    	pushl  0xb60
  db:	68 47 08 00 00       	push   $0x847
  e0:	6a 01                	push   $0x1
  e2:	e8 f9 03 00 00       	call   4e0 <printf>
	here = 2;
  e7:	c7 05 64 0b 00 00 02 	movl   $0x2,0xb64
  ee:	00 00 00 
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 83 08 00 00       	mov    $0x883,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 54 0b 00 00       	mov    %eax,0xb54
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 54 0b 00 00    	mov    0xb54,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 54 0b 00 00    	cmp    %eax,0xb54
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 807:	0b 00 00 
 80a:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 58 0b 00 00       	mov    $0xb58,%eax
 819:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 820:	00 00 00 
